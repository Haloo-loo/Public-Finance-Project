...
if __name__ == '__main__':
    ...
    if args.debug:
        count_dict = craw_and_write('https://www.ahmhxc.com/gongzuobaogao/',indices, 13463, 13467)
    else:
        count_dict = craw_and_write('https://www.ahmhxc.com/gongzuobaogao/',indices, 10000, 22000)
    
    if args.debug:
        All_data.to_csv('./outputs/debug.csv')
    else:
        try:
            All_data.to_csv('./outputs/WITH_GOV_REPORT_v2.csv')
        except:
            pass
        
        try:
            All_data.to_excel('./outputs/WITH_GOV_REPORT_v2.xlsx')
        except:
            pass
